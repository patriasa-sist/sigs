...
-   [x] Abrir modal de cuotas para una póliza
-   [x] Click en "Registrar Pago" para una cuota pendiente
-   [x] Ingresar monto igual a la cuota
-   [x] Seleccionar tipo de comprobante: "Factura"
-   [x] Click en área de upload
-   [x] Seleccionar imagen JPG < 10MB
-   [x] Verificar preview del archivo (nombre, tamaño)
-   [x] Click "Confirmar Pago"
-   [x] **Esperado**: Pago registrado exitosamente, comprobante visible en DB
...
-   [x] Intentar subir archivo > 10MB
-   [x] **Esperado**: Error "El archivo excede el tamaño máximo de 10MB"

#### TC-1.3: Validación de Tipo de Archivo

-   [x] Intentar subir archivo .txt o .exe
-   [x] **Esperado**: Error "Tipo de archivo no permitido. Use JPG, PNG, WebP o PDF"

#### TC-1.4: Comprobante es Obligatorio

-   [x] Intentar confirmar pago sin adjuntar archivo
-   [x] **Esperado**: Error "Debe adjuntar un comprobante de pago (obligatorio)"
-   [x] Botón "Confirmar Pago" debe estar deshabilitado

#### TC-1.5: Upload de Diferentes Tipos

-   [x] Subir JPG (debe funcionar)
-   [x] Subir PNG (debe funcionar)
-   [x] Subir WebP (debe funcionar)
-   [x] Subir PDF (debe funcionar)

### 🧪 Testing de Mejora #2: Sin Restricción Mensual

#### TC-2.1: Pago de Cuota Vencida Fuera de su Mes

-   [x] Identificar cuota con `estado = 'vencido'` y `fecha_vencimiento` hace 2+ meses
-   [x] Click "Registrar Pago"
-   [x] Ingresar monto y adjuntar comprobante
-   [x] **Esperado**: Pago registrado sin errores de restricción mensual
