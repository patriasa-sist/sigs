...
export const PolicySchema = z.object({
	...
	prima_total: z.number().nonnegative("Prima total no puede ser negativa"),
	moneda: CurrencyEnum,
	prima_neta: z.number().nonnegative("Prima neta no puede ser negativa"),
	comision: z.number().nonnegative("Comisión no puede ser negativa"),
