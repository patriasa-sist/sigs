...
import { obtenerCategorias, obtenerCategoriasStats } from "./actions";
		...
		<div className="flex-1 w-full flex flex-col gap-6">
			...
			<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
				<div>
					...
					<p className="text-gray-600 mt-1">Gestiona las categorías de pólizas (grupos de negocios)</p>
				</div>
				<CategoriaFormDialog />
			</div>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>Categorías utilizadas para agrupar pólizas por tipo de negocio</CardDescription>
				</CardHeader>
				<CardContent>
