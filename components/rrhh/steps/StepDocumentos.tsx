				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
					<div>
						...
						<Select
							...
							onValueChange={(v) => setTipoSeleccionado(v as TipoDocumentoEmpleado)}
						>
					...
					<div className="flex items-end">
						<label className="w-full">
							<div
								className={`flex items-center justify-center gap-2 border rounded-md h-10 px-4 cursor-pointer text-sm font-medium transition-colors ${
									uploading
					...
					{docs.map((doc) => (
						<div
							...
							className={`flex items-center gap-3 px-3 py-2.5 rounded-lg border ${
								doc.upload_status === "error" ? "border-destructive/30 bg-destructive/5" : "bg-card"
							}`}
						>
