...
const EMPTY: DatosLaborales = {
	...
	area_solicitante: "",
	medio_comunicacion: "",
	medio_comunicacion_desc: "",
	entrevistado_por_nombre: "",
	entrevistado_por_cargo: "",
	entrevistado_fecha: "",
	aprobado_por_nombre: "",
	aprobado_por_cargo: "",
	aprobado_fecha: "",
...
export default function StepLaboral({ data, onSave, onBack }: Props) {
	...
	const set = <K extends keyof DatosLaborales>(k: K, v: DatosLaborales[K]) => setForm((p) => ({ ...p, [k]: v }));
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
					<div>
						...
						<Select
							...
							onValueChange={(v) => set("area_solicitante", v as AreaSolicitante | "")}
						>
					...
					<div>
						...
						<Select
							value={form.medio_comunicacion}
							onValueChange={(v) => set("medio_comunicacion", v as MedioComunicacion | "")}
						>
							<SelectTrigger className="mt-1">
								<SelectValue placeholder="Seleccione" />
							</SelectTrigger>
			...
			<div>
				...
				<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
					<div>
						<Label>Nombre</Label>
						<Input
							value={form.entrevistado_por_nombre}
							onChange={(e) => set("entrevistado_por_nombre", e.target.value)}
							className="mt-1"
						/>
					</div>
					<div>
						<Label>Cargo</Label>
						<Input
							value={form.entrevistado_por_cargo}
							onChange={(e) => set("entrevistado_por_cargo", e.target.value)}
							className="mt-1"
						/>
					</div>
					<div>
						...
						<Input
							type="date"
							value={form.entrevistado_fecha}
							onChange={(e) => set("entrevistado_fecha", e.target.value)}
							className="mt-1"
						/>
					</div>
				</div>
			...
			<div>
				...
				<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
					<div>
						<Label>Nombre</Label>
						<Input
							value={form.aprobado_por_nombre}
							onChange={(e) => set("aprobado_por_nombre", e.target.value)}
							className="mt-1"
						/>
					</div>
					<div>
						<Label>Cargo</Label>
						<Input
							value={form.aprobado_por_cargo}
							onChange={(e) => set("aprobado_por_cargo", e.target.value)}
							className="mt-1"
						/>
					</div>
					<div>
