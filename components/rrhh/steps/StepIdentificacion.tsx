			...
			<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
				...
				<div>
					...
					<Select
						...
						onValueChange={(v) => set("tipo_documento", v as TipoDocumento)}
					>
				...
				<div>
					...
					<Input
						value={form.nro_nua_cua}
						onChange={(e) => set("nro_nua_cua", e.target.value)}
						className="mt-1"
					/>
				</div>
				<div>
				...
				{form.nacionalidad === "otra" && (
					<div>
						<Label>
							Especificar Nacionalidad <span className="text-destructive">*</span>
						</Label>
						<Input
							value={form.otra_nacionalidad}
							onChange={(e) => set("otra_nacionalidad", e.target.value)}
							className="mt-1"
						/>
				...
				{(form.estado_civil === "casado" || form.estado_civil === "union_libre") && (
					<div>
						...
						<Input
							...
							onChange={(e) => set("nombre_conyuge", e.target.value)}
							className="mt-1"
						/>
					</div>
				)}
