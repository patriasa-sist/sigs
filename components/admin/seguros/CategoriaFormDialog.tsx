...
import { crearCategoria, actualizarCategoria } from "@/app/admin/seguros/categorias/actions";
		...
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="sm:max-w-[425px]">
				<DialogHeader>
					...
					<DialogDescription>
						{isEditing ? "Modifica los datos de la categoría." : "Ingresa los datos de la nueva categoría."}
					</DialogDescription>
				</DialogHeader>
