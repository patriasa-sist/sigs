...
import { desactivarProducto, reactivarProducto } from "@/app/admin/seguros/productos/actions";
...
export function ProductosTable({ data, aseguradoras, ramos }: ProductosTableProps) {
	...
	const filteredData = useMemo(() => {
		return data.filter((producto) => {
			...
			if (filterAseguradora !== "all" && producto.compania_aseguradora_id !== filterAseguradora) {
				return false;
			}

			// Filter by ramo
			if (filterRamo !== "all" && producto.tipo_seguro_id.toString() !== filterRamo) {
				return false;
			}
					...
					<Table>
						<TableHeader>
							<TableRow>
								...
								<TableHead className="w-[240px] whitespace-normal">Nombre</TableHead>
								<TableHead className="hidden lg:table-cell w-[280px] whitespace-normal">
									Aseguradora
								</TableHead>
								<TableHead className="hidden md:table-cell w-[220px] whitespace-normal">Ramo</TableHead>
