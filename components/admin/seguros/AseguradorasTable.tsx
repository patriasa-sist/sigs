...
import { desactivarAseguradora, reactivarAseguradora } from "@/app/admin/seguros/aseguradoras/actions";
						...
						<TableBody>
							{filteredData.map((aseguradora) => (
								<TableRow key={aseguradora.id}>
									...
									<TableCell>
										<span className="text-muted-foreground">{aseguradora.codigo || "-"}</span>
									</TableCell>
									<TableCell>
