...
import { desactivarDirectorCartera, reactivarDirectorCartera } from "@/app/admin/directores-cartera/actions";
						...
						<TableBody>
							{filteredData.map((director) => (
								<TableRow key={director.id}>
									...
									<TableCell>
										<span className="text-muted-foreground">{director.apellidos || "-"}</span>
									</TableCell>
									<TableCell>
