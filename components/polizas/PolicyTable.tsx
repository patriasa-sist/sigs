		...
		return (
			<div className="flex flex-col items-center justify-center py-16 px-4">
				...
				<p className="text-sm text-gray-500 text-center max-w-md">
					No hay pólizas que coincidan con tu búsqueda. Intenta con otros términos o limpia los filtros.
				</p>
			</div>
		);
	}
					...
					{policies.map((policy) => {
						...
						return (
							...
							>
								...
								{/* Total Payments */}
								<td className="px-4 py-4">
									<span className="text-sm text-gray-700">{paymentStats.totalPayments} pagos</span>
								</td>
								...
								<td className="px-4 py-4">
									<div className="flex items-center gap-2">
										...
										<span className="text-xs text-gray-500 min-w-[35px]">{paymentPercentage}%</span>
									</div>
								</td>
