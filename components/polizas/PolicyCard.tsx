		...
		>
			...
			<div className="flex items-start justify-between mb-4">
				<div className="flex-1">
					<div className="flex items-center gap-2 mb-2">
						...
						<h3 className={`text-lg font-semibold ${isHighlighted("policyId") ? "bg-yellow-200" : ""}`}>
							{policy.policyId}
						</h3>
					</div>
			...
			<div className="grid grid-cols-2 gap-4 mb-4 pb-4 border-b">
				...
				<div>
					...
					<div className="text-sm font-semibold text-green-600">{formatCurrency(policy.totalPremium)}</div>
				</div>
				<div>
			...
			<div className="mb-4">
				<div className="flex justify-between text-xs text-gray-600 mb-1">
					...
					<span>{Math.round((paymentStats.paidPayments / paymentStats.totalPayments) * 100)}%</span>
				</div>
			...
			>
				<span className="text-sm font-medium text-gray-700">Ver Cronograma de Pagos</span>
				{isExpanded ? (
